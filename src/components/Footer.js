        ...
        <div className=" items-start ml-6">
          <div className="flex">
            <a href="https://www.linkedin.com/in/ahmedmagedev">
              <FaLinkedin className="text-accent w-6 h-6 flex-shrink-0 mr-4" />
            </a>
            <a href="mailto:ahmedmagedev@gmail.com">
              <MdOutlineMail className="text-accent w-6 h-6 flex-shrink-0 mr-4" />
            </a>
          </div>
        </div>
        <div className="items-end mr-6">
          <p>© 2025 Ahmed Maged. All rights reserved.</p>
        </div>
      </div>
    </section>
  );
