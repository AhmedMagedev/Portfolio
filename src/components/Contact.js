    ...
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-impreza-dark relative flex flex-wrap py-6 px-8 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <p className="leading-relaxed">+20 112 832 3253</p>
              <p className="leading-relaxed">+20 106 851 1562</p>
            </div>
          </div>
        </div>
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="text-white bg-impreza-orange border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
          >
            Submit
          </button>
        </form>
